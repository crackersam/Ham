...
data class MakeupStyle(
    ...
    val eyeshadowSparkle: Float = 0f, // 0..1 shimmer/glitter intensity
    val highlightSparkle: Float = 0f, // 0..1 sparkle intensity for highlight regions
    val foundationAlpha: Float = 0f,
    val foundationTint: Color = Color(0xFFD7B19C),
    val foundationCoverage: Float = 0f,
    val contourAlpha: Float = 0f,
    val concealerLift: Float = 0f,
    val concealerNeutralize: Float = 0f,
...
val MAKEUP_STYLES = listOf(
    ...
    MakeupStyle(
        ...
        highlightSparkle = 0.18f,
        eyeshadowSparkle = 0.24f,
        foundationAlpha = 0.62f,
        foundationTint = Color(0xFFE0B9A5),
        foundationCoverage = 0.26f,
        contourAlpha = 0.14f,
        concealerLift = 0.34f,
        concealerNeutralize = 0.30f,
    ...
    MakeupStyle(
        ...
        highlightSparkle = 0.26f,
        eyeshadowSparkle = 0.40f,
        foundationAlpha = 0.62f,
        foundationTint = Color(0xFFD9AE97),
        foundationCoverage = 0.30f,
        contourAlpha = 0.18f,
        concealerLift = 0.42f,
        concealerNeutralize = 0.38f,
    ...
    MakeupStyle(
        ...
        highlightSparkle = 0.46f,
        eyeshadowSparkle = 0.30f,
        foundationAlpha = 0.70f,
        foundationTint = Color(0xFFE5C2B0),
        foundationCoverage = 0.34f,
        contourAlpha = 0.16f,
        concealerLift = 0.56f,
        concealerNeutralize = 0.48f,
    ...
    MakeupStyle(
        ...
        highlightSparkle = 0.38f,
        eyeshadowSparkle = 0.62f,
        foundationAlpha = 0.60f,
        foundationTint = Color(0xFFD4A68F),
        foundationCoverage = 0.28f,
        contourAlpha = 0.20f,
        concealerLift = 0.50f,
        concealerNeutralize = 0.44f,
