...
val MAKEUP_STYLES = listOf(
    ...
    MakeupStyle(
        id = "foundation",
        name = "Foundation",
        lipColor = Color(0xFFD8B5A6),
        eyeshadowColor = Color(0xFFE7C6B7),
        blushColor = Color(0xFFD8B5A6),
        linerColor = Color.Transparent,
        lipAlpha = 0f,
        eyeshadowAlpha = 0f,
        blushAlpha = 0f,
        linerAlpha = 0f,
        foundationAlpha = 0.85f,
        foundationTint = Color(0xFFE2BDA9),
        foundationCoverage = 0.55f,
    ),
)
